...
public class ImageUtil {
    ...
    public static void setBurryImage(ImageView imageView, int scale, Bitmap bitmap) {
    ...
    public static void setBurryImageSrc(ImageView imageView, int scale) {
        ...
        Bitmap burryBitmap = fastBlur(originBitmap,scale);
        Bitmap resultBitmap = Bitmap.createScaledBitmap(burryBitmap, burryBitmap.getWidth() * scale, burryBitmap.getHeight() * scale, false);
