...
public class NewDateItem extends DataSupport{
    ...
    public static List<NewDateItem> fromJson2List(String jsonString){
        Gson gson = new GsonBuilder().create();
        Type type = new TypeToken<List<NewDateItem>>() {}.getType();
        List<NewDateItem> dateItems = gson.fromJson(jsonString, type);
        return dateItems;
    }

    public static NewDateItem fromJson(String jsonString){
        Gson gson = new GsonBuilder().create();
        NewDateItem dateItem = gson.fromJson(jsonString, NewDateItem.class);
        return dateItem;
    }
