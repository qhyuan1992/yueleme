 ...
 */
public class DateItem extends DataSupport{
    ...
    public static List<DateItem> fromJson2List(String jsonString){
        Gson gson = new GsonBuilder().create();
        Type type = new TypeToken<List<DateItem>>() {}.getType();
        List<DateItem> dateItems = gson.fromJson(jsonString, type);
        return dateItems;
    }

    public static DateItem fromJson(String jsonString){
        Gson gson = new GsonBuilder().create();
        DateItem dateItem = gson.fromJson(jsonString, DateItem.class);
        return dateItem;
    }
